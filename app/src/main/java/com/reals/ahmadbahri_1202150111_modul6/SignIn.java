...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUsername.setText("realsoncores@gmail.com");
        txtPassword.setText("jancok");
                ...
                .addOnCompleteListener(SignIn.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            loading.dismiss();
                            Toast.makeText(SignIn.this, "Username / Password Salah", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void register(){
        ...
        loading.show();
        auth.createUserWithEmailAndPassword(user, pin).addOnCompleteListener(SignIn.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    loading.dismiss();
                    Toast.makeText(SignIn.this, "Berhasil Register", Toast.LENGTH_SHORT).show();
                    finish();
                    startActivity(new Intent(SignIn.this,SignIn.class));
                }else{
                    loading.dismiss();
                    Toast.makeText(SignIn.this, "Gagal Register", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
